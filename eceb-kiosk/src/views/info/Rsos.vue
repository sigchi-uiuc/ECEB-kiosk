<template>
  <div class="organizations page">
    <div class="info-title">
      Ways To Get Involved With Energy
    </div>
    ...
    <div id="org-carousel">
      ...
      <div id="groups-carousel">
        <v-carousel :show-arrows="false" :hide-delimiters="true" v-model="slide" height="760px">
          <v-carousel-item v-for="group in rsoData.groups" :key="group.name + '-row'" class="group-carousel-right">
            <v-img class = "group-carousel-image" :src="require('../../assets/' + group.image)"/>
            <v-img class= "group-carousel-qrcode" :src="require('../../assets/' + group.qrcode)"/>
...
export default {
  ...
  watch: {
    ...
    slide: function (index) {
      ...
      let oldActive = document.getElementById(this.rsoData.groups[this.active].name  + "-button");
      let newActive = document.getElementById(this.rsoData.groups[index].name  + "-button");
  ...
  mounted() {
    let activeButton = document.getElementById(this.rsoData.groups[this.active].name + "-button");
